export const NavbarCodeExemple = `<nav class="navbar--red text--white mb-4">
    <div class="container">
        <h2 class="site--title">Shinobi CSS</h2>
        <label class="navbar--mobile--btn" for="navbar--input">Menu</label>
        <input
            type="checkbox"
            name="navbar--input"
            id="navbar--input"
...
export const ButtonExemple = `<button class="btn">default</button>
